...
IMAGE_NAME_INPUT="${IMAGE_NAME:-webcam-topic-yolo-bridge}"
IMAGE_NAME="${IMAGE_NAME_INPUT,,}"
CONTAINER_NAME="${CONTAINER_NAME:-webcam_topic_yolo_bridge}"
...
echo "Running webcam topic YOLO bridge container"
