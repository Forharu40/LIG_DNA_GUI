...
IMAGE_NAME="${IMAGE_NAME:-camera-yolo-live}"
...
Environment overrides:
  ...
  ENABLE_TILE_INFERENCE, ALLOWED_CLASSES
EOF
}
...
echo "Running live camera Docker image: $IMAGE_NAME"
...
sudo docker run "${docker_args[@]}" "$IMAGE_NAME" python3 /app/stream_live_camera_yolo.py
